...
-R = rekurencyjnie (bez tego sprawdza tylko jeden plik)
...
Fragment (domyślnie, najczęstsze)
...
🔧 Sekcja 4 — przypadki praktyczne i decyzje końcowe
❓ Używasz pipe?
ps aux | grep ssh
...
❓ Chcesz tylko nazwy plików (bez treści)?
grep -Rl "TEKST" .
